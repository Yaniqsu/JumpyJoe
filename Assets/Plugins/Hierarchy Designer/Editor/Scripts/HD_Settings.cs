...
namespace HierarchyDesigner
{
    internal static class HD_Settings
    {
        ...
        private static void LoadSettingsIntoCaches()
        {
            ...
            HD_Manager.EnableSceneSwitcherCache = EnableSceneSwitcher;
        ...
        {
            get => generalSettings.EnableSceneSwitcher;
            set
            {
                if (generalSettings.EnableSceneSwitcher != value)
                {
                    generalSettings.EnableSceneSwitcher = value;
                    HD_Manager.EnableSceneSwitcherCache = value;
                }
            }
        }
