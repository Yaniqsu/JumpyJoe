...
namespace HierarchyDesigner
{
    ...
    internal class HD_Main : EditorWindow
    {
        ...
        private bool tempEnableSceneSwitcher;
        ...
        private void DrawGeneralSettingsMainFeatures()
        {
            ...
            tempEnableSceneSwitcher = HD_GUI.DrawToggle("Enable Scene Switcher", generalSettingsMainToggleLabelWidth, tempEnableSceneSwitcher, true, true, "Displays a “▾” dropdown button in the hierarchy scene header for quick scene switching.");
        ...
        private void UpdateAndSaveGeneralSettingsData()
        {
            ...
            HD_Settings.EnableSceneSwitcher = tempEnableSceneSwitcher;
        ...
        private void LoadGeneralSettingsData()
        {
            ...
            tempEnableSceneSwitcher = HD_Settings.EnableSceneSwitcher;
        ...
        private void EnableAllGeneralSettingsFeatures(bool enable)
        {
            ...
            tempEnableSceneSwitcher = enable;
