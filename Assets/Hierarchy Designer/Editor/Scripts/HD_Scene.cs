...
{
    internal static class HD_Scene
    {
        #region Properties
        ...
        #region Methods
        public static void DrawSceneHeaderDropdown(Rect selectionRect)
        {
        ...
        private static Rect ComputeSceneArrowRect(Rect row, int sceneIndex)
        {
            ...
            float maxArrowX = Mathf.Round(row.xMax - Gap - ArrowSize);
                    ...
                    using (new EditorGUILayout.HorizontalScope())
                    {
                        ...
                        using (new EditorGUILayout.VerticalScope(GUILayout.ExpandHeight(true)))
                        {
                            scroll = GUILayout.BeginScrollView(
                                scroll, false, true, GUIStyle.none, GUI.skin.verticalScrollbar, GUIStyle.none, GUILayout.ExpandHeight(true));
